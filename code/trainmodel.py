...
class Model:
    def createAndSaveModel(self):
        ...
        x_train = x_train_generator.flow_from_directory('/home/harshal/Desktop/FruitClassification/fruits/Train',
                                                        target_size=(64, 64), batch_size=32, class_mode='categorical',
                                                        color_mode="rgb")

        x_test = x_test_generator.flow_from_directory('/home/harshal/Desktop/FruitClassification/fruits/Test',
                                                      target_size=(64, 64), batch_size=32, class_mode='categorical')

        # fit the images to thmagese model
        classifier.fit_generator(x_train, steps_per_epoch=150, epochs=20, validation_data=x_test, validation_steps=1000)
